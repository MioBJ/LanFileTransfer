...
const iconData = computed(() => iconPaths[props.name] || null)

const iconStyle = computed(() => ({
  color: props.color || 'currentColor',
  width: typeof props.size === 'number' ? `${props.size}px` : props.size || '24px',
  height: typeof props.size === 'number' ? `${props.size}px` : props.size || '24px',
}))
</script>
